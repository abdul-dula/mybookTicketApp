        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              Column(
                children: [
                  InkWell(onTap: (){print("You are tapped");}, child: Text("Edit",style: Styles.textStyle.copyWith(color: Styles.primaryColor,fontWeight: FontWeight.w300),)),
                ],
              ),
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Text("You have 95 flight in a year", style: Styles.headLineStyle2.copyWith(
                          fontWeight: FontWeight.w500,color: Colors.white.withOpacity(0.8),
                          fontSize: 16,
                        ),),
                      ],
                    )
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                Text("568894",style: TextStyle(fontSize: 45,color: Styles.textColor,fontWeight: FontWeight.w600),),
                Gap(AppLayout.getHeight(20),),
                Row(
                ...
                Gap(AppLayout.getHeight(12),),
                Divider(color: Colors.grey.shade300,), /*الخط الخفيف */
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: const[
                ...
                Row(
                  ...
                  children: const[
                    ...
                    AppColumnLayout( firstText: 'Abdulrahman', secondText: "Received from", alignment: CrossAxisAlignment.end,isColor: false,),
