              ...
              Column(
                children: [
                  Stack(
                    children: [
                      ...
                      Positioned(
                        ...
                        decoration: BoxDecoration(
                          shape:  BoxShape.circle,
                          border: Border.all(width: 18,color: Color(0xFF57678f)),
                          color: Colors.transparent,
                        ),
                      ),)
                    ],
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        Text("Enjoy your flight", style: Styles.headLineStyle2.copyWith(color: Colors.white,fontWeight: FontWeight.bold,),textAlign: TextAlign.center,),
                        Gap(AppLayout.getHeight(17)),
                        RichText(text: const TextSpan(
                          children: [
                          TextSpan(text: '😍', style: TextStyle(fontSize: 38)),
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    Gap(AppLayout.getHeight(15)),
                    Text("Looking for Business Class flights? Look no more for you are at the right place.",
